...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>app-assets/css/themes/horizontal-menu-template/materialize.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>app-assets/css/themes/horizontal-menu-template/style.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>app-assets/css/layouts/style-horizontal.css">
        ...
        <div class="col s12">
            <div class="container">
                <div id="login-page" class="row">
                    <div style="margin-left: 0;" class="col s12 m6 l4 login-card">
                        <?php echo $this->Core->massage();?>
                        <form class="login-form s12 m6 l4 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8" method="POST" action="<?php echo base_url(); ?>/login/prosesLogin">
                            <div class="row">
